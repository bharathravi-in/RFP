...
class RFPSectionType(db.Model):
    ...
    color = db.Column(db.String(20))  # Hex color code (e.g., #3B82F6) for UI differentiation
    template_type = db.Column(db.String(100))  # narrative, table, card, or technical
    recommended_word_count = db.Column(db.Integer)  # Target word count for this section
